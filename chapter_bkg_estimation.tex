...
\begin{table}[ht]
    ...
    \resizebox{\textwidth}{!}{% <------ Don't forget this %
        \begin{tabular}{lll}
            ...
            \hline
            \ttbar, $tW$ (2$\ell$)                         & irreducible, $b$-jet fails identification                & CR using $b$-tagging\\
            $Z(\to \tau \tau)$+jets                        & irreducible fully leptonic $\tau$                        & CR using $m_{\tau \tau}$\\
            $Z(\to ee, \mu \mu)$+jets                      & instrumental \met                                        & MC\\
...
The \ttbar, $tW$, $Z/\gamma(\to \tau \tau)$+jets decay to same flavor lepton pairs ($ee$ and $\mu \mu$) and different flavor lepton pairs ($e\mu$ and $\mu e$) at the same rates.
...
The dominant sources of the irreducible background are \ttbar $tZ$, $WW/WZ$, $Z/\gamma(\to \tau \tau)$ + jets and are estimated using the MC simulation samples.
These SM processes contain two prompt leptons, \met, and jets, therefore, they can mimic the Higgsino signal.
