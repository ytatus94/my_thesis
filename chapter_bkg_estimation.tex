...
\begin{figure}[ht]
    \begin{center}
        \begin{subfigure}[b]{0.48\textwidth}
            \includegraphics[scale=0.4]{hist1d_met_Et_VR-SS-ee-me.pdf}
            \caption{$ee+\mu e$}
            \label{fig:bkg_ee_mue_fake_distribution}
        \end{subfigure}
        \begin{subfigure}[b]{0.48\textwidth}
            \includegraphics[scale=0.4]{hist1d_met_Et_VR-SS-mm-em.pdf}
            \caption{$\mu \mu + e\mu$}
...
The uncertainty of the pileup re-weighting is obtained by varying the scaling factor between 1.00 and 1.23.
