    ...
    \resizebox{\textwidth}{!}{% <------ Don't forget this %
        \begin{tabular}{lll}
            ...
            \hline
                                     & Electrons                                   & Muons\\
            \hline
            \multirow{4}{*}{}        & $\pt > 4.5$~{\GeV}                          & $\pt > 4$~{\GeV}\\
                                     & $|\eta| < 2.47$                             & $|\eta| < 2.5$\\
                                     & $|z_{0} \sin \theta| < 0.5$~mm              & $|z_{0} \sin \theta| < 0.5$~mm\\
                                     & pass \texttt{LooseAndBLayer} identification & pass \texttt{Medium} identification\\
            \hline
            \multirow{3}{*}{}        & !\texttt{Tight} identification              & \\
                                     & or $|d_{0}/\sigma(d_{0})| > 5$              & $|d_{0}/\sigma(d_{0})| > 3$\\
                                     & or !\texttt{GradientLoose} isolation        & or !\texttt{FixedCutTightTrackOnly} isolation\\
            \hline
            \hline
        \end{tabular}
    }
...
The leading jet \pt for the events used for fake factor measurement are required to be greater than 100~{\GeV} making the fake factor measurement region similar to SR.
