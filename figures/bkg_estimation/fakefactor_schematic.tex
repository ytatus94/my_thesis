\begin{tikzpicture}
    ...
    \node at (-0.05,1.2) [left] {Select an antiID};
    ...
    % box labels
    \node at (2,2) [below] {$N_\mathrm{antiID}$};
    ...
    \node at (6.5,5.2) [below] {$N_\mathrm{est} = \underbrace{\left(\displaystyle\frac{N_\mathrm{ID}}{N_\mathrm{antiID}}\right)}_{\equiv F}\cdot N_\mathrm{CR-fake}$};
    \node at (6.5,3.6) [below] {\textbf{Signal region}};
    \node at (6.5,3.15) [below] {fake estimate};
    
    \node at (6.5,2) [below] {$N_\mathrm{CR-fake}$};
