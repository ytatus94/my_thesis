...
\usepackage[top=1.0in, bottom=1.0in, left=1.6in, right=1.0in]{geometry}
...
%%% BEGIN DOCUMENT
\begin{document}
%\layout % show layout parameters
%% Place Dissertation information here
\author{Yu-Ting Shen}
\university{University of Oklahoma}
\college{Graduate College}
\department{Homer L. Dodge Department of Physics and Astronomy}
\title{SEARCH FOR ELECTROWEAK PRODUCTION OF SUPERSYMMETRIC STATES IN THE NON-UNIVERSAL HIGGS MASS MODEL WITH COMPRESSED SPECTRA WITH THE ATLAS DETECTOR}
\address{Norman, Oklahoma}
\yr{2018}
\dgname{Doctor of Philosophy}
%% List your committee members here
\committee{{Dr. Patrick Skubic, Chair}, Dr. Michael Strauss, {Dr. Howie Baer}, Dr. Deborah Watson, {Dr. Zhisheng Shi}}
...
% Graduate College require bibliography must put in front of appendix
\bibliographystyle{unsrt}
%% You need a file named `outhesis_references.bib' to use BibTex here
%\bibliography{outhesis_references}
\bibliography{bib_introduction,bib_standard_model,bib_susy,bib_atlas_experiment,bib_data,bib_event_reconstruction,bib_bkg_estimation,bib_appendix}
...
\input{appendix_electron_isolation}

%\chapter{Search for strongly-produced SUSY in final states with two same-sign or three leptons and jets using 36.1~\ifb $pp$ collision data at $\sqrt{s} = 13$~{\TeV} with the ATLAS detector}
...
\input{appendix_real_lepton_efficiency}
