...
\label{app:electron_reconstruction_identification_isolation}
...
\bibliography{bib_introduction,bib_standard_model,bib_atlas_experiment,bib_susy,bib_data,bib_event_reconstruction,bib_appendix}
