...
The discovery of the Higgs boson ($H$) by the ATLAS and CMS collaborations at CERN completes the missing part of the SM predictions~\cite{Aad:2012tfa, Chatrchyan:2012xdj}.
...
Supersymmetry (SUSY)~\cite{Wess:1973kz, Wess:1974tw, Golfand:1971iw, Martin:1997ns} is one of the most promising extensions of the SM.
...
\begin{figure}[htbp]
    \begin{center}
        ...
        \caption{The scatter plot in the $m(\widetilde{\chi}^{0}_{1})$ vs $m(\widetilde{\chi}^{\pm}_{1})$ plane of the lightest neutralino in a MSSM scan~\cite{Aaboud:2016wna}.
