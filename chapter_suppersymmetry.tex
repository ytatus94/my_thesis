...
The reason why physicists favour SUSY is described in Section~\ref{sec:susy_why_susy} and the introduction of the SUSY is given in Section~\ref{sec:susy_intro} and the formulaism is depicted in Section~\ref{sec:susy_}.
