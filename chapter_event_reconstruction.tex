...
The mass of $\tau$ lepton is 1.77~{\GeV} and the decay length is 80~$\mu$m which is too short to make $\tau$ reach the active region of the ATLAS detector.
The $\tau$ can decay either leptonically ($\tau \to \ell \nu_{\ell}$, $\ell = e, \mu$) or hadronically ($\tau \to$ hadrons + $\nu_{\tau}$).
The hadronic tau decays are about 65\% of all possible decay modes and the decay products contain one charged pion (22\%) or three charged pions (72\%) of all cases.
...
Jet is removed if $\Delta R(\mathrm{jets}, e) < 0.2$ from the remaining electrons unless it is a $b$-jet.
If there are less than 3 tracks with $\pt > 500$~{\MeV} in a jet and the distance between jets and a muon candidate less than 0.4, i.e. $\Delta R(\mathrm{jets}, \mu) < 0.4$, then the jet is removed.
...
\begin{itemize}
    ...
    The $\Delta R_{\ell\ell}$ variable, which is required to greater than 0.05, suppresses muons causing fake pairs of tracks or the lepton pairs originating from photon conversions.
    %
    \begin{equation}
    ...
    The background originating from on-shell $Z$ decay can be suppressed if the upper bound of $m_{\ell\ell}$ is set to 60~{\GeV} and the contributions from $J/\psi$ are vetoed by required a $3 < m_{\ell\ell} < 3.2$~{\GeV} window.
...
\begin{figure}[htb]
    \begin{center}
        ...
        \includegraphics[scale=0.25]{METOverHT_vs_mll.png}
...
Events with 2 lepton final state are selected if the lepton pair satisfies same flavor and opposite charge (SFOS).
...
The $m_{\ell\ell}$ binnings are listed in Table~\ref{tab:event_signal_region_binning}.
...
%                 \hline
%                 \multirow{5}{*}{350}     & acceptance            & 0.0305                                     & 0.0202                                         & 0.0171                                     & 0.0134\\
%                                          & cross-section         & 0.5835                                     & 0.9549                                         & 0.6833                                     & 0.3984\\
%                                          & branching ratio       & 0.1014                                     & 0.1111                                         & 0.1014                                     & 0.1014\\
%                                          & filter efficiency     & 0.2277                                     & 0.1299                                         & 0.2558                                     & 0.2529\\
%                                          & expected events in SR & 14.85                                      & 10.05                                          & 10.91                                      & 4.94\\
%                 \hline
%                 \multirow{5}{*}{400}     & acceptance            & 0.0329                                     & 0.0212                                         & 0.0177                                     & 0.0180\\
%                                          & cross-section         & 0.6256                                     & 0.8416                                         & 0.6845                                     & 0.3977\\
%                                          & branching ratio       & 0.1029                                     & 0.1110                                         & 0.1029                                     & 0.1029\\
%                                          & filter efficiency     & 0.2042                                     & 0.1220                                         & 0.2239                                     & 0.2206\\
%                                          & expected events in SR & 15.60                                      & 8.71                                           & 10.11                                      & 5.85\\
%                 \hline
%                 \multirow{5}{*}{500}     & acceptance            & 0.0362                                     & 0.0243                                         & 0.0237                                     & 0.0229\\
%                                          & cross-section         & 0.6603                                     & 0.7281                                         & 0.6819                                     & 0.3956\\
%                                          & branching ratio       & 0.1054                                     & 0.1110                                         & 0.1054                                     & 0.1054\\
%                                          & filter efficiency     & 0.1760                                     & 0.1082                                         & 0.1881                                     & 0.1892\\
%                                          & expected events in SR & 15.99                                      & 7.66                                           & 11.57                                      & 6.53\\
%                 \hline
%                 \multirow{5}{*}{600}     & acceptance            & 0.0425                                     & 0.0243.                                        & 0.0273                                     & 0.0271\\
%                                          & cross-section         & 0.6657                                     & 0.6745                                         & 0.6791                                     & 0.3930\\
%                                          & branching ratio       & 0.1076                                     & 0.1110                                         & 0.1076                                     & 0.1076\\
%                                          & filter efficiency     & 0.1535                                     & 0.1000                                         & 0.1693                                     & 0.1687\\
%                                          & expected events in SR & 16.85                                      & 6.57                                           & 12.19                                      & 6.99\\
%                 \hline
%                 \multirow{5}{*}{700}     & acceptance            & 0.0445                                     & 0.0252                                         & 0.0312                                     & 0.0290\\
%                                          & cross-section         & 0.6643                                     & 0.6439                                         & 0.6766                                     & 0.3913\\
%                                          & branching ratio       & 0.1097                                     & 0.1110                                         & 0.1097                                     & 0.1097\\
%                                          & filter efficiency     & 0.1379                                     & 0.0935                                         & 0.1587                                     & 0.1580\\
%                                          & expected events in SR & 16.12                                      & 6.08                                           & 13.27                                      & 7.10\\
%                 \hline
%                 \multirow{5}{*}{800}     & acceptance            & 0.0433                                     & 0.0243                                         & 0.0304                                     & 0.0260\\
%                                          & cross-section         & 0.6598                                     & 0.6240                                         & 0.6749                                     & 0.3906\\
%                                          & branching ratio       & 0.1116                                     & 0.1110                                         & 0.1116                                     & 0.1116\\
%                                          & filter efficiency     & 0.1283                                     & 0.0872                                         & 0.1463                                     & 0.1392\\
...
\begin{figure}[htbp]
    \begin{center}
        \begin{subfigure}[b]{0.48\textwidth}
            \includegraphics[scale=0.35]{NUHM2_m12_500_and_Bkg_nJet30_SFOS_N_minus_one_distribution_in_SR_times_10_on_Nsig.pdf}
            \caption{$N^{30}_{\mathrm{jets}}$}
            \label{fig:event_nuhm2_m12_500_nJet30_SFOS}
        \end{subfigure}
        \begin{subfigure}[b]{0.48\textwidth}
            \includegraphics[scale=0.35]{NUHM2_m12_500_and_Bkg_nBJet20_MV2c10_SFOS_N_minus_one_distribution_in_SR_times_10_on_Nsig.pdf}
            \caption{$N^{20}_{\mathrm{b-jets}}$}
            \label{fig:event_nuhm2_m12_500_nBJet20_SFOS}
        \end{subfigure}
        \begin{subfigure}[b]{0.48\textwidth}
            \includegraphics[scale=0.35]{NUHM2_m12_500_and_Bkg_lep1Pt_SFOS_N_minus_one_distribution_in_SR_times_10_on_Nsig.pdf}
            \caption{$p^{\ell_1}_{\mathrm{T}}$}
            \label{fig:event_nuhm2_m12_500_lep1Pt_SFOS}
        \end{subfigure}
        \begin{subfigure}[b]{0.48\textwidth}
            \includegraphics[scale=0.35]{NUHM2_m12_500_and_Bkg_lep2Pt_SFOS_N_minus_one_distribution_in_SR_times_10_on_Nsig.pdf}
...
\begin{figure}[htbp]
    \begin{center}
        \begin{subfigure}[b]{0.48\textwidth}
            \includegraphics[scale=0.35]{NUHM2_m12_500_and_Bkg_met_Et_SFOS_N_minus_one_distribution_in_SR_times_10_on_Nsig.pdf}
            \caption{$E^{\mathrm{miss}}_{\mathrm{T}}$}
            \label{fig:event_nuhm2_m12_500_met_SFOS}
        \end{subfigure}
        \begin{subfigure}[b]{0.48\textwidth}
            \includegraphics[scale=0.35]{NUHM2_m12_500_and_Bkg_METOverHTLep_SFOS_N_minus_one_distribution_in_SR_times_10_on_Nsig.pdf}
            \caption{$E^{\mathrm{miss}}_{\mathrm{T}} / H^{\mathrm{leptons}}_{\mathrm{T}}$}
            \label{fig:event_nuhm2_m12_500_METOverHTLep_SFOS}
        \end{subfigure}
        \begin{subfigure}[b]{0.48\textwidth}
            \includegraphics[scale=0.35]{NUHM2_m12_500_and_Bkg_mll_SFOS_N_minus_one_distribution_in_SR_times_10_on_Nsig.pdf}
            \caption{$m_{\ell\ell}$}
            \label{fig:event_nuhm2_m12_500_mll_SFOS}
        \end{subfigure}
        \begin{subfigure}[b]{0.48\textwidth}
            \includegraphics[scale=0.35]{NUHM2_m12_500_and_Bkg_MTauTau_SFOS_N_minus_one_distribution_in_SR_times_10_on_Nsig.pdf}
            \caption{$m_{\tau\tau}$}
...
\begin{figure}[htbp]
    \begin{center}
        ...
        %\end{subfigure}
        \begin{subfigure}[b]{0.48\textwidth}
            \includegraphics[scale=0.35]{NUHM2_m12_500_and_Bkg_mt_lep1_SFOS_N_minus_one_distribution_in_SR_times_10_on_Nsig.pdf}
            \caption{$m_{T}(\ell_{1})$}
            \label{fig:event_nuhm2_m12_500_mt_lep1_SFOS}
        \end{subfigure}
        \begin{subfigure}[b]{0.48\textwidth}
            \includegraphics[scale=0.35]{NUHM2_m12_500_and_Bkg_Rll_SFOS_N_minus_one_distribution_in_SR_times_10_on_Nsig.pdf}
            \caption{$\Delta R_{\ell\ell}$}
            \label{fig:event_nuhm2_m12_500_Rll_SFOS}
        \end{subfigure}
        \begin{subfigure}[b]{0.48\textwidth}
            \includegraphics[scale=0.35]{NUHM2_m12_500_and_Bkg_DPhiJ1Met_SFOS_N_minus_one_distribution_in_SR_times_10_on_Nsig.pdf}
            \caption{$|\Delta \phi(\mathbf{p}^{j_{1}}_{\mathrm{T}}, \mathbf{p}^{\mathrm{miss}}_{\mathrm{T}})|$}
            \label{fig:event_nuhm2_m12_500_DPhiJ1Met_SFOS}
        \end{subfigure}
        \begin{subfigure}[b]{0.48\textwidth}
            \includegraphics[scale=0.35]{NUHM2_m12_500_and_Bkg_minDPhiAllJetsMet_SFOS_N_minus_one_distribution_in_SR_times_10_on_Nsig.pdf}
