...
\subsubsection{Truth study}
\label{subsubsec:event_truth_study}
The truth information in the signal MC samples are used to calculate the acceptance of the SR selection criteria.
And the expected yields can be obtained by taking the product of luminosity (36.1~\ifb), acceptance, filter efficiency, cross-section, and the branching ratio.
Table~\ref{tab:event_nuhm2_truth3} shows the acceptance, the cross-section, the branchings for different production channels, the 2LMET50 filter efficiency, and the expected yields in SR.
