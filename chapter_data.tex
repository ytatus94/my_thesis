...
The $R$-parity conservation requires $\widetilde{\chi}^{0}_{1}$, which is LSP, to be stable.
Therefore, the $\widetilde{\chi}^{0}_{1} \widetilde{\chi}^{0}_{1}$ production cannot lead to events with two leptons requirement.
