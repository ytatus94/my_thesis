...
In the with and without systematics cases, the $CLs_{obs}$ should be worse (higher) than the $CLs_{exp}$ due to a small excess observed in some $m_{\ell \ell}$ bins.
...
Since this situation does not seen in the without systematics case, therefore, this situation happens when increasing systematic uncertainties for these two $m_{1/2}$.
...
\end{equation}
%
where $\mu_\mathrm{sig}$ is the signal strength, and the four $\sigma_{prod}$ are the cross-section for different productions at next-to-leading-logarithm (NLL) accuracy.
The upper limit of the cross-section plot with and without systematics are shown in Fig.~\ref{fig:results_nuhm2_interpretation_mc_production}.
The grey numbers are the upper limits of the cross-section in $pb$.
...
\begin{figure}[htbp]
    ...
    The grey numbers are the upper limits in $pb$.}
