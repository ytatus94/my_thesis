...
The kinematic distribution comparisons in TRUTH level using the NUHM2 samples with $m_{1/2} = 600$~{\GeV} and the simplified Higgsino samples with $m_{\widetilde{\chi}^{0}_{2}} = 170$~{\GeV}, $m_{\widetilde{\chi}^{0}_{1}} = 150$~{\GeV} are shown in Figs.~\ref{fig:dist_nuhm2_lepton_multiplicity} to \ref{fig:dist_nuhm2_met_METOverHTLep12_Rll_dphiMin1}.
...
\begin{figure}[htbp]
    ...
    The NUHM2 distributions are multiplied by 10 but the number of events in the legends are actual values.}
